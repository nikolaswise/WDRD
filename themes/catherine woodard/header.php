          ...
          <div id="nav-container">
            <h1 class="nav-header">
              <a class="header-link" href="<?php echo home_url()?>">
                Catherine Woodard
                <!-- <img src="/wp-content/themes/cathywoodard/img/name-thin.png" title="Catherine Woodard" alt="Catherine Woodard" id="name-img" /> -->
              </a>
            </h1>

            <ul id="navigation">
              <li class="navigation-item"><a href="/about/">About</a></li>
              <li class="navigation-item"><a href="/poems/">Poems</a></li>
              <li class="navigation-item"><a href="/publications/">Publications</a></li>
              <li class="navigation-item"><a href="/news/">News</a></li>
              <li class="navigation-item"><a href="/events/">Events</a></li>
              <li class="navigation-item"><a href="/contact/">Contact</a></li>
              <li class="navigation-item"><a href="https://twitter.com/cathywoodard">
              ...
              <li class="navigation-item"><a href="https://www.instagram.com/catherinewoodard/">
              ...
              <li class="navigation-item"><a href="https://www.facebook.com/catherinewoodardwriter">
